...
# 1 "mcc_generated_files/nco1.h" 1
# 58 "mcc_generated_files/tmr1.h" 2
...
_Bool NCO1_Increase(uint24_t ncoIncVal, uint24_t maxInc)
{
    uint24_t ncoVal;
    ncoVal = NCO1_Read();
    if(ncoVal < maxInc){
...
_Bool NCO1_Decrease(uint24_t ncoIncVal, uint24_t minInc)
{
    uint24_t ncoVal;
    ncoVal = NCO1_Read();
    if(ncoVal > minInc){
